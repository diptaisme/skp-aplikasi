 ...
 * @author Sony
 */
public class DBqueryInsertRevisiTarget {

    Connection conn;

    public DBqueryInsertRevisiTarget(Connection conn) {
        this.conn = conn;
    }
    ...
    public void insertTupoksi(String maks, String id_4faktor, String _iNip_id, String UnorIdisert, String IdTupoksi, String ikuantitas4, String ikualitas4, String iWaktu4, String iBiaya, String ipilih, String iwaktuL) throws SQLException {
        String _maks = maks;
        String __iNip_id = _iNip_id;
        String _IdTupoksi = IdTupoksi;
        String _ikuantitas4 = ikuantitas4;
...
//        _iwaktuL = vs.getmashudi();
        ...
        String sql = "INSERT INTO revisi4faktor(revisi,id_isi4faktor, nip_pns, id_unor,id_tupoksi, kuantitas4, kualitas4, waktu4, biaya4, kuantitas_label, waktu_label) VALUES('" + _maks + "','" + _id_4faktor + "', '" + __iNip_id + "', '" + _UnorIdisertL + "', '" + _IdTupoksi + "', '" + _ikuantitas4 + "', '" + _ikualitas4 + "', '" + _iWaktu4 + "', '" + _iBiaya + "', '" + _ipilih + "', '" + _iwaktuL + "')";
        PreparedStatement st = this.conn.prepareStatement(sql);
//        st.setString(1, maks);

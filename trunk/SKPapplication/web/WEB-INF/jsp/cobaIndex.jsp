...
<html>
    <head>
		...
		<link rel="shortcut icon" href="/SKPapplication/images/favicon.ico" type="image/x-icon"/>
        <link rel="stylesheet" href="/SKPapplication/css/style.css" type="text/css" media="screen"/>
    ...
    <body>
		...
		<div id="cc_menu" class="cc_menu">
			<div class="cc_item" style="z-index:5;">
				<img src="/SKPapplication/images/SasaranSKI.jpg" alt="image" />
			...
			<div class="cc_item" style="z-index:4;">
				<img src="/SKPapplication/images/CapaianSKI.jpg" alt="image" />
				<div class="cc_submenu">
					<ul>
			...
			<div class="cc_item" style="z-index:3;">
					...
					<ul>
                    	...
                    	<div id="cc_content" class="cc_content">
                                ...
                                <div class="cc_content_1">
                                    <a href="RequestServlet?page=index"><p style="font-size:24px;color:whitesmoke">Formulir Sasaran Kerja</p></a>
				...
				<div class="cc_content_2">
					<a href="RequestServlet?page=indexRealisasi"><p style="font-size:24px;color:whitesmoke">Penilaian Capaian Sasaran Kerja</p></a>

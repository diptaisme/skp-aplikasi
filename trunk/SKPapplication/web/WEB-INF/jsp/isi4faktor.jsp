...
<html>
    <head>
        ...
        <link href="/SKPapplication/css/button.css" type="text/css" rel="stylesheet" media="screen,projection" />
        <script src="/SKPapplication/js/animation.js" type="text/javascript" charset="UTF-8"></script>
<style type="text/css">

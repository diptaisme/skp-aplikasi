<%-- 
    Document   : navigasiPenggunadat_2
    Created on : 04 Dec 14, 11:06:57
    Author     : Diptaisme
--%>
    ...
    <body>
        ...
        <div id="wrapperUtama">
            ...
            <div id="content50">
                ...
                <c:if test="${navigasi_pilihan =='100' }">
                       <li>
                           <input type="text" id="eselon1" name="eselon1" value="${eselon1}"/> 
                           <a id="url3" target="_blank"  title="Cetak" onclick="redirect3()"><img src="images/tambah.png"/></a>
                       </li>
                       <li>
                           <input type="text" id="eselon2" name="eselon2" value="${eselon2}"/> 
                           <a id="url3" target="_blank"  title="Cetak" onclick="redirect3()"><img src="images/tambah.png"/></a>
                       </li>
                       <li>
                           <input type="text" id="eselon3" name="eselon3" value="${eselon3}"/> 
                           <a id="url3" target="_blank"  title="Cetak" onclick="redirect3()"><img src="images/tambah.png"/></a>
                       </li>
                       <li>
                           <input type="text" id="eselon4" name="eselon4" value="${eselon4}"/> 
                           <a id="url3" target="_blank"  title="Cetak" onclick="redirect3()"><img src="images/tambah.png"/></a>
                       </li>
                       <li>
                           <input type="text" id="eselon5" name="eselon5" value="${eselon5}"/> 
                           <a id="url3" target="_blank"  title="Cetak" onclick="redirect3()"><img src="images/tambah.png"/></a>
                       </li>       
                </c:if>
                    ...
                    <li><a href="#"><div style="font-size: 20px">... </div></a>
                        <ul>
                            <c:if test="${tingkat=='3'}">
                                ...
                                <li><a href="NavigasiProfile?addUnor=<c:out value="${sessionScope.NipPnsSession}"/>">Edit Unor</a></li>

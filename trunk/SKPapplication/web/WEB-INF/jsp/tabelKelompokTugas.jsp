...
<title>Kelompok Tugas Tupoksi</title>
         ...
         <form name="form1" method="post" action="tupoksiServlet">
           ...
           <input  type="hidden"  name="idnipText" value="${pns.getNipBaru()}"/>
            <table width="1000" border="0">
                    ...
                    <td><div align="center"><strong>KELOMPOK TUGAS </strong></div></td>
                 
            
             
                <c:forEach var="listUnosi" items="${tupoksiServlets}" varStatus="count">
                    <tr>
                        <td><div align="center">${(count.index)+1}</div></td>
                        <td><div align="left"><a href="tupoksiServlet?nipKelokpokKriteria=<c:out value="${pns.getNipBaru()}"/>&namaKelompok=<c:out value="${listUnosi.getnamaKelompok()}"/>">${listUnosi.getnamaKelompok()}</a></div></td>
                       <%-- <td><div align="Left"><a href="tupoksiServlet?nipKelokpokKriteria=<c:out value="${pns.getNipBaru()}"/>&namaKelompok=<c:out value="${listUnosi.getnamaKelompok()}"/>"${listUnosi.getnamaKelompok()}</a></div></td>--%>
                    </tr>
                </c:forEach> 
            </table>

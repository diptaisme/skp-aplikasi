...
<div id="templatemo_site_title_bar_wrapper">
    <div id="templatemo_site_title_bar">
        <div id="templatemo_menu">
            <ul>
                <li><a href="SKIBiru.jsp" class="current" title="SKI"><span></span>SKI</a></li>
                <li><a href="indexBaruBiru2.jsp" target="_parent" title="Target Sasaran SKI"><span></span>Target</a></li>
                <li><a href="indexRealisasiBaruBiru.jsp" target="_parent" title="Realisasi Capaian SKI"><span></span>Realisasi</a></li>

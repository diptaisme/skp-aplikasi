            ...
            <form method="post" name="form1"  onsubmit="return validasitest()"  action="isiPerilakuServlet"> 
                                ...
                                <div STYLE=" height: 100px;   width: 250px; font-size: 12px; overflow: auto;">                  
                                    <table  align="top" width="320">
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="image" src="images/cari.png" id="cariNipMon" name="cariNipMon" value="cari"/></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="image" src="images/cari.png" id="cariNamaMon" name="cariNamaMon" value="cari"/></td>
                                        </tr>                          
                                    </table></div>
                            </div>
                ...
                <div id="rightIsian">
                    <div id="rightIsian2">
                        ...
                        <div id="foobar">   
                            <div id="col2">
                                <div class="viewer">        <div class="reel"> 
                                        <div class="slide">                     <img src="images/arrow-on-target.jpg" width="100" height="130" alt="" /> <span>S.K.P</span>
                                        </div><div class="slide">                <img src="images/blurry.jpg" width="100" height="130" alt="" /> <span>S.K.P</span>
                                        </div><div class="slide">                <img src="images/sukses.jpg" width="100" height="130" alt="" /> <span>S.K.P</span>
                                        </div><div class="slide">                <img src="images/meeting.jpg" width="100" height="130" alt="" /> <span>S.K.P</span>
                        ...
                        <td >  <img src="images/Spining Globe_thumb[1].gif" width="100" height="100"/></td>

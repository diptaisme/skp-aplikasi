    ...
    <body>
        ...
        <div id="templatemo_content4" class="scroll2">
            <form name="form1" method="post" action="tupoksiServlet">
                <p>Pencarian Kelompok Tugas : <input name="cariKriteriaKlTgs" type="text"  value="${namaKelompok}" size="75"/> <input name="submitCari" type="Submit" value="CARIKLTGS" class="button black bigrounded"/>  </p>   
                <p>Pencarian Uraian Tugas   : <input name="cariKriteria" type="text" size="75"/> <input name="submitCari" type="Submit" value="CARI" class="button black bigrounded"/>  </p>   
                ...
                <table width="1000" border="0">
                    ...
                    <c:forEach var="listUnosi" items="${unosiServlet}" varStatus="count">
                        <tr>
                            ...
                            <td><a href="isiTupoksiServlet?isCetak=true&nipnilai=<c:out value="${pns.getNipBaru()}"/>&kelompokTugas=<c:out value="${namaKelompok}"/>&idTupoksi=<c:out value="${listUnosi.getIdTupoksi()}"/>"><div align="center">${listUnosi.getIdTupoksi()}  </div></a><input type="checkbox" name ="tupoksipaporit" value="${listUnosi.getIdTupoksi()}"</td>
                            <td>${listUnosi.getNamaTupoksi()}</td>
                            <td>${listUnosi.getangka_krdt()}</td>
                        </tr>
                    </c:forEach> 
                </table>

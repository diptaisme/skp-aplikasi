    ...
    <body>
        <div id="wrapper">
            <div id="header">
                ...
                <div id="menuKecil">
                    <ul>
                        <li><a href="GetPnsServlet?txtNIPBaruB=<c:out value="${pnsp.getNipBaru()}"/>&sesiontahun=${sesiontahun}" target="_parent" title="Target Sasaran SKI"><span></span>Kembali</a></li>	
            ...
            <form method="post" name="form1" id="form1" action="Isi4FaktorServlet" onsubmit="return validasitest4Faktor()">
                <div id="pageKecil">
                    ...
                    <table width="600" border="0">
                        <tr>
                        <input type="hidden" name="nipIsiBulanTarget" id="nipIsiBulanTarget" value="${pnsp.getNipBaru()}" />
                        ...
                        <tr >
                            ...
                            <td><input type="text" id="session" name="session" onkeypress="return alertnipnull3(event)" value="${sesiontahun}" /> </td>
                ...
                <div id="pageKecil-bottomkecil">
                    <table width="600" border="0">
                        ...
                        <tr>
                            ...
                            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong><span class="style2"> <textarea id="textarea1" name="detailkegiatan" cols="40" rows="6"></textarea></td>
                                        </tr>
                                        ...
                                        <input type="submit" name="param"  value="LANJUT" />

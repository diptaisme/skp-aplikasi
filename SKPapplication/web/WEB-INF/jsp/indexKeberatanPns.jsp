...
<body>
 ...
 <form method="post" name="form1" action="keberatanServlet">   
     <div id="">
         <table width="100%" border="0">
             <tr>
                 <td width="10%"><strong>STAFF PEJABAT STRUKTURAL</strong></td>
                 <td width="30%"><strong>KEBERATAN PNS</strong></td>
                 <td width="30%"><strong>TANGGAPAN KEBERATAN DARI ATASAN LANGSUNG</strong></td>
                 <td width="30%"><strong>KEPUTUSAN KEBERATAN DARI PEJABAT PENILAI</strong></td>
             </tr>
             <tr>
                 <td valign="top">
                     <table width="10%">
                         ...
                         <tr>
                             <td colspan="3" valign="bottom">
                                 <input type="submit" name="param" class="button black bigrounded" value="KELUAR">
                             </td>
                         </tr>
                     </table>
                 </td>
                <td valign="top">
                    <table width="30%">
                        ...
                        <tr>
                            <td><strong><span class="style2">PERIODE</span></strong></td>
                            <td><input type="text" name="periode" value="${Disiplin}"></input></td>
                        </tr>
                        <tr>
                            <td width="120" colspan="2"><textarea rows="19" cols="44"></textarea></td>
                        </tr>
                        <tr>
                            <td colspan="2"><input type="submit" name="param" class="button black bigrounded" value="KEBERATAN"></td>
                        </tr>
                    </table>  
                </td>
                <td valign="top">
                    <table width="30%">
                        ...
                        <tr>
                            <td colspan="2"><input type="submit" name="param" class="button black bigrounded" value="TANGGAPAN"></td>
                        </tr>
                    </table>  
                </td>
                <td valign="top">
                    <table width="30%">
                        ...
                        <tr>
                            <td colspan="2"><input type="submit" name="param" class="button black bigrounded" value="KEPUTUSAN"></td>
                        </tr>
                    </table>  
                </td>
            </tr>

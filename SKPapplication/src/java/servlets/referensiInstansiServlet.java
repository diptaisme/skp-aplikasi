...
//kalau struktural yang dihapus harus liat unor dan instansi nya dulu!!!
        ...
        } else if (carijabatan != null) {
            String kelJabatan = request.getParameter("kelJab");
            String jenisJabatan2 = request.getParameter("jabatan2");

            String cariUmum = request.getParameter("cari_nama");
            if (jenisJabatan2 != null) {
                ModelLocatorSKP.jenisJabatan = Integer.valueOf(jenisJabatan2);
            } else {
                ModelLocatorSKP.jenisJabatan = 4;
                jenisJabatan2 = "4";
            }
            ...
            if (ModelLocatorSKP.jenisJabatan == 2) {
                ...
                request.setAttribute("kelJab", kelJab);
                // request.setAttribute("jabatanfungfum", jabatanfungfum);
                sb.append("<select id ='jabatanfungfum' name ='jabatanfungfum'>");
                for (int i = 0; i < jabatanfungfum.size(); i++) {
                    sb.append("<option value=" + jabatanfungfum.get(i).getId() + ">" + jabatanfungfum.get(i).getNama() + "</option>");
                ...
                //request.setAttribute("kelJab", kelJab);
                // request.setAttribute("jabatanfungfum", jabatanfungfum);
                sb.append("<select id ='jabatanfungfum1' name ='jabatanfungfum1' >");
                for (int i = 0; i < jabatanfungfum.size(); i++) {
                    sb.append("<option value=" + jabatanfungfum.get(i).getId() + ">" + jabatanfungfum.get(i).getNama() + "</option>");
                }
            ...
            // String jenisJabatan = Integer.toString(ModelLocatorSKP.jenisJabatan);
        ...
        } else if (request.getParameter("idInstkode") != null)//klik link instansi
        {
